fn main() {
    ...
    println!(
        "{}",
        serde_json::json!({
         "evidence-field.schema.json":schemars::schema_for!(EvidenceFieldRef),"capabilities.schema.json":schemars::schema_for!(CaptureCapabilities),"batch.schema.json":schemars::schema_for!(CaptureBatch),"record.schema.json":schemars::schema_for!(CaptureRecord),"context.schema.json":schemars::schema_for!(CaptureContext),
